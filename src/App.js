    ...
    return (
      <div>
        <Router>
          ...
          <button className="link bag" onClick={handleUserLogout}><HiUserRemove /></button>
        ) : (
          <Link className="link bag" to="/login"><HiOutlineUser /></Link>
        )}

            {/*
            {!isLoggedIn ? (
          <Link className="link bag" to="/Login"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-person" viewBox="0 0 16 16">
