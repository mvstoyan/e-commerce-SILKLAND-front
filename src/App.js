...
import SILKLAND from "./Components/SILKLAND";
...
function App() {
  const cart = useSelector((state) => state.cart); // Accesses the cart state using the useSelector hook

  const [isLoggedIn, setLoggedIn] = useState(false); // Manages the logged-in state
  ...
  const handleUserLogin = async (user) => {
    ...
    if (success) {
      setLoggedIn(true); // If login is successful, sets isLoggedIn state to true
    }
    setLoading(false); // Sets loading state back to false
  };
      ...
      <Router>
        <nav className="navbar">
          ...
          {isLoading ? (
            ...
            <button className="link bag" onClick={handleUserLogout}>
              <HiUserRemove />
            </button>
          ) : (
            <Link className="link bag" to="/login">
              <HiOutlineUser />
            </Link>
          )}

          <Link className="link bag" to="/Cart">
            <svg
        ...
        <Routes>
          ...
          <Route
            ...
            element={
              !isLoggedIn ? (
                <Login handleLogin={handleUserLogin} />
              ) : (
                <Navigate to="/" replace />
              )
            }
            // Renders the Login component with props:
            // - handleUserLogin: function for user login
        ...
        <div className="footer">
          <div className="footer-container">
            ...
            <div className="footerLinks">
              ...
              <a
                href="https://www.etsy.com/shop/SILKLANDstore?ref=shopinfo_shopname_favoriters"
                target="_blank"
                className="footerLink"
                rel="noreferrer"
              >
            ...
            <div className="footerLinks">
              <button className="footerLink">
                {" "}
                Subscribe to our mailimg list to stay up to date with our
                promotions and news
              </button>
              <ContactForm />
            </div>
