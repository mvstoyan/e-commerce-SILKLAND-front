    ...
    if (state.succeeded) {
      ...
      return (
        ...
        <div className="faq-container">
            ...
            <button className="faq-title" onClick={() => setShowMore(!showMore)}>Shipping Information</button>
            ...
            <button className="faq-title" onClick={() => setShowMore(!showMore)}>Highlights</button>
            ...
            <button className="faq-title" onClick={() => setShowMore(!showMore)}>Need Help?</button>
            {showMore ? <div>
        ...
        <button className="btn" type="submit" disabled={state.submitting}>Send</button>
            ...
            <a href="/shop"  rel="noreferrer"><button className="faq-btn">Shop now</button></a>
        </div>
        </div>
